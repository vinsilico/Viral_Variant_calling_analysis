...
write.csv(snp_quasi_6VCs_median, file="snp_quasi_MILK_6VCs_median.txt")
...
write.table(snp_quasi_6VCs_median_Mix4_unique, file="Alpha_snp_quasi_6VCs_median_Mix4_unique.txt", sep="\t")
...
point_plot
ggsave("Final_MILK_Mix_Median_color_by_caller_trend_600.tiff",units="in", width= 12, height = 6, device='tiff', dpi=600)
ggsave("Final_MILK_Mix_Median_color_by_caller_trend_300.tiff",units="in", width= 12, height = 6, device='tiff', dpi=300)
ggsave("Final_MILK_Mix_Median_color_by_caller_trend_300.png",units="in", width= 12, height = 6, device='png', dpi=300)
...
point_plot
ggsave("Final_MILK_Mix_Median_gp_by_caller_trend_600.tiff",units="in", width= 12, height = 6, device='tiff', dpi=600)
ggsave("Final_MILK_Mix_Median_gp_by_caller_trend_300.tiff",units="in", width= 12, height = 6, device='tiff', dpi=300)
ggsave("Final_MILK_Mix_Median_gp_by_caller_trend_300.png",units="in", width= 12, height = 6, device='png', dpi=300)
...
point_plot
ggsave("Final_MILK_Mix_Median_color_by_caller_recall_600.tiff",units="in", width= 12, height = 6, device='tiff', dpi=600)
ggsave("Final_MILK_Mix_Median_color_by_caller_recall_300.tiff",units="in", width= 12, height = 6, device='tiff', dpi=300)
ggsave("Final_MILK_Mix_Median_color_by_caller_recall_300.png",units="in", width= 12, height = 6, device='png', dpi=300)
...
point_plot <- ggplot(snp_quasi_6VCs_median_Mix4, aes(precision, caller, color=caller)) +
  ...
  theme(legend.position = "bottom")  
point_plot
ggsave("Final_MILK_Mix_Median_color_by_caller_pre_600.tiff",units="in", width= 12, height = 6, device='tiff', dpi=600)
ggsave("Final_MILK_Mix_Median_color_by_caller_pre_300.tiff",units="in", width= 12, height = 6, device='tiff', dpi=300)
ggsave("Final_MILK_Mix_Median_color_by_caller_pre_300.png",units="in", width= 12, height = 6, device='png', dpi=300)
...
#   theme(legend.position = "bottom")  
# point_plot 
# ggsave("Final_MILK_Mix_Median_color_by_caller_recall_300_box.png",units="in", width= 12, height = 6, device='png', dpi=300)
...
point_plot <- ggplot(snp_quasi_6VCs_median_Mix4_unique, aes(recall, caller, color=caller)) +
  ...
  theme(legend.position = "bottom")  
point_plot
ggsave("Final_MILK_Mix_Median_color_by_caller_recall_300_box_jitterpoints.png",units="in", width= 12, height = 6, device='png', dpi=300)
...
point_plot <- ggplot(snp_quasi_6VCs_median_Mix4_unique, aes(precision, caller, color=caller)) +
  ...
  theme(legend.position = "bottom")  
point_plot
ggsave("Final_MILK_Mix_Median_color_by_caller_pre_300_box_jitterpoints.png",units="in", width= 12, height = 6, device='png', dpi=300)

#point plotting only the Mix samples by median values colour gradient by alpha concentration in multi by caller with geom trend line
jit <- position_jitter(seed=123)
point_plot <- ggplot(snp_quasi_6VCs_median_Mix4, aes(precision, recall, color=ALPHA)) + 
...
point_plot
ggsave("Final_MILK_Mix_Median_BR_grad_color_by_caller_trend_group_by_color_300.png",units="in", width= 12, height = 6, device='png', dpi=300)
ggsave("Final_MILK_Mix_Median_BR_grad_color_by_caller_trend_group_by_color_600.tiff",units="in", width= 12, height = 6, device='tiff', dpi=600)
ggsave("Final_MILK_Mix_Median_BR_grad_color_by_caller_trend_group_by_color_300.tiff",units="in", width= 12, height = 6, device='tiff', dpi=300)
...
ggsave("Final_MILK_Mix_Median_color_by_caller_group_by_Mix_ID2_sorted_300.png",units="in", width= 12, height = 6, device='png', dpi=300)
ggsave("Final_MILK_Mix_Median_color_by_caller_group_by_Mix_ID2_sorted_600.tiff",units="in", width= 12, height = 6, device='tiff', dpi=600)
ggsave("Final_MILK_Mix_Median_color_by_caller_group_by_Mix_ID2_sorted_300.tiff",units="in", width= 12, height = 6, device='tiff', dpi=300)
